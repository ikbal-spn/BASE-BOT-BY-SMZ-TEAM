...
ensureFileExists(settings.databaseSettings.storeDb, databaseTemplates.store);
...
const storeDb = new Database(settings.databaseSettings.storeDb, databaseTemplates.store);
